...
<body>
	<div id="container">
		<h1>Mesa de Partes Virtual - <a href="http://www.muniricardopalma.gob.pe/prueba4.php">Ricardo Palma</a></h1>
		<?php
		...
		<form action="send.php" method="post" enctype="multipart/form-data">
			<fieldset>
				<legend>llena el formulario Correctamente</legend>
				<ul>
					<li>
					...
					<li>
						...
						<br>
						<input type="email" id="mailr" name="emailr" value= "mesadepartes@muniricardopalma.gob.pe" readonly>
					</li>
					<li>
